...
export function ChevronUpIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
...
export function ChevronDownIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m6 9 6 6 6-6"/></svg>
  );
}

export function ChevronLeftIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
...
export function ChevronRightIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m9 18 6-6-6-6"/></svg>
  );
}

export function CloseIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
  );
}

export function SearchIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
...
export function FilterIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
...
export function DownloadIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
...
export function EyeIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
...
export function CheckIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
...
export function AlertIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
...
export function InfoIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
...
export function UploadIcon({ className, size = 20 }: IconProps): React.JSX.Element {
  return (
